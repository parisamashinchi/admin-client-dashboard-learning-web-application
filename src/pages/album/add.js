                                                                  ...
                                                                  <Col span={11}>
                                                                    ...
                                                                    >
                                                                          <Select
                                                                              ...
                                                                              // disabled={this.state.edit_state ? "disabled" : loading}
                                                                              value={this.state.models[index].albumables_id}
                                                                              onSearch={(value) => this.onSearch(value, this.state.models[index].type, 'filter[header_title]')}
                                                                              onChange={value => this.changeSource(value, index, 'albumables_id', value => form.setFieldsValue({
                                                                                  models: value,
                                                                              }))}
...
const mapStateToProps = state => ({
    dataLoading: state.getIn(
        [formConstants.FORM, `${constants.ALBUM}_data_loading`],
        false
    ),
    initialData: state.getIn(
        [formConstants.FORM, `${constants.ALBUM}_data`, 'data'],
        false
    ),
    albumData: state.getIn(
        [constants.ALBUM, 'data'],
        {}
    ),
    filteredData: state.getIn(
        [constants.ALBUM, 'filtered'],
        {}
    ),
    loading: state.getIn(
        [formConstants.FORM, `${constants.ALBUM}_loading`],
        false
    ),
});
